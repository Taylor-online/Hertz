...
<div class ="container-fluid">
    ...
    <div class="container-fluid">
   <li><a> <div class="clients clients2"><h1>Clients</h1></div></li></a>

    <form method='GET'>
    

        <div class="c1"><input type="text" name="nom_cli" placeholder="nom"class="fontcolo">
...
?>
    <br><br>
    <li><a> <h1 class="titrevehicule">Véhicule</h1></li></a>
    <form method='GET'>
