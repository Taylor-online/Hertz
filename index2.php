      ...
      <div class="row  mt-5 ml-5">
        <div class="col-12 col-sm-6 col-xl-2">
          <div class="bouton">
            ...
            <div class="form-field contact-form submit-btn col-lg-12">
            <a href="http://localhost/hertz/login.php"target="blank"> <input class="submit-btn" type="submit" value="S'identifer"></a>
            </div>
            <div class="form-field contact-form submit-btn col-lg-12">
              <a href="http://localhost/hertz/inscription.php"target="blank">  <input class="submit-btn" type="submit" value="S'inscrire"></a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container mt-3">
      <div class="row">
        ...
        <hr style="height: 3px; color:#ffd100; background-color: #ffd100; width: 200px; border-radius: 5px;"
          class="trait2">
        <img src="Hertz/marques/toyota.png" alt="logo toyota" class="logo" width="150px"> </hr><div id="toyota"></div>       
      ...
      <div class="row justify-content-center">
        ...
        <div class="container mt-3">
          <div class="row">
            ...
            <hr style="height: 3px; color:#ffd100; background-color: #ffd100; width: 200px; border-radius: 5px;"
              class="trait2">
            <img src="Hertz/marques/citroen.png" alt="logo citroen" class="logo" width="150px"> </hr><div id="Citroën"></div>
            <hr style="height: 3px; color: #ffd100; background-color:#ffd100; width: 600px; border-radius: 5px;"
              class="trait2">
            </hr>
          </div>
          ...
          <div class="row justify-content-center">
            ...
            <div class="container mt-3">
              <div class="row">
                ...
                <hr style="height: 3px; color:#ffd100; background-color: #ffd100; width: 200px; border-radius: 5px;"
                  class="trait2">
                <img src="Hertz/marques/peugeot.png" alt="logo peugeot" class="logo" width="150px"> </hr><div id="Peugeot"></div>
                <hr style="height: 3px; color: #ffd100; background-color:#ffd100; width: 600px; border-radius: 5px;"
                  class="trait2">
                </hr>
              </div>
              ...
              <div class="row justify-content-center">
                ...
                <div class="container mt-3">
                  <div class="row">
                    ...
                    <hr style="height: 3px; color:#ffd100; background-color: #ffd100; width: 200px; border-radius: 5px;"
                      class="trait2">
                    <img src="Hertz/marques/volsawgen.png" alt="logo peugeot" class="logo" width="120px"> </hr><div id="Volkswagen"></div>
                    <hr style="height: 3px; color: #ffd100; background-color:#ffd100; width: 600px; border-radius: 5px;"
                      class="trait2">
                    </hr>
                  </div>
                    ...
                    <div class="container mt-3">
                      <div class="row">
                        ...
                        <hr
                          ...
                          class="trait2">
                        <img src="Hertz/marques/renault.png" alt="logo peugeot" class="logo" width="150px"> </hr><div id="Renault"></div>
                        <hr
                      ...
                      <div class="container mt-3">
                        <div class="row">
                          ...
                          <hr
                            style="height: 3px; color:#ffd100; background-color: #ffd100; width: 200px; border-radius: 5px;"
                            class="trait2">
                          <img src="Hertz/marques/lexus.png" alt="logo peugeot" class="logo" width="150px"> </hr><div id="Lexus"></div>
                          <hr
                            style="height: 3px; color: #ffd100; background-color:#ffd100; width: 600px; border-radius: 5px;"
                            class="trait2">
                          </hr>
